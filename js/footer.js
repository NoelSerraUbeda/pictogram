  ...
  connectedCallback() {
    ...
    openSVG.addEventListener('click', () => {
      if (this.configVisible) {
        configDiv.style.transform = 'translate(0, 42rem)';
    ...
    const colorDivs = this.shadow.querySelectorAll('.color-div');
    colorDivs.forEach(colorDiv => {
      colorDiv.addEventListener('click', () => {
        colorDivs.forEach(div => div.classList.remove('active'));
        colorDiv.classList.add('active');
        const eventData = colorDiv.dataset.color;
        const event = new CustomEvent('colorSelected', { detail: eventData });
  ...
  render() {
    this.shadow.innerHTML = /*html*/`
      <style>
        ...
        .color-div[data-color="red"] {
          background-color: red;
        }

        .color-div[data-color="blue"] {
          background-color: blue;
        }

        .color-div[data-color="green"] {
          background-color: green;
        }

        .color-div[data-color="yellow"] {
          background-color: yellow;
        }

        .color-div[data-color="orange"] {
      ...
      <div class="config">
        <div class="color-div" data-color="red"></div>
        <div class="color-div" data-color="blue"></div>
        <div class="color-div active" data-color="green"></div>
